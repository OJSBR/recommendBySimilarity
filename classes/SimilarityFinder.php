...
/**
 * @file plugins/generic/recommendBySimilarity/classes/SimilarityFinder.php
 *
...
class SimilarityFinder
{
    ...
    public function terms(string $searchPhrase): array
    {
        ...
        return array_slice(
            array_unique(Application::getSubmissionSearchIndex()->filterKeywords($searchPhrase, false, true, true)),
            0,
    ...
    public function find(int $submissionId, int $contextId, array $terms, int $limit): array
    {
        ...
        $keywordIds = DB::table('submission_search_keyword_list')
        ...
        return DB::table('submission_search_object_keywords as ok')
