...
**⬇️ Install package:** [OJS 3.5](https://github.com/OJSBR/recommendBySimilarity/releases/download/2.0.0.0/recommendBySimilarity-2.0.0.0.tar.gz) — or browse all [Releases](../../releases).
